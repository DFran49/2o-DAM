...
public class miControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        usuarioTextField.prefWidthProperty().bind(Bindings.createDoubleBinding( //Valor que es devuelto: double
                ...
                usuarioTextField.textProperty() //En qué momento realiza el bind 
                 //(cada vez que cambia la propiedad textProperty)
        ));
        ...
        miBoton.disableProperty().bind(Bindings.or(usuarioTextField.textProperty().isEmpty(),
