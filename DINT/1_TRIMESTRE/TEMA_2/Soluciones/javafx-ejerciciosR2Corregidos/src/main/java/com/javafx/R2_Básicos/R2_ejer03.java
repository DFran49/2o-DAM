...
public class R2_ejer03 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //Crear ToolBar Manual con 3 botones
        // ToolBar toolBar = new ToolBar();  Lo único que CAMBIAMOS!!
        ...
        //Lo único que CAMBIAMOS!!
        //toolBar.getItems().addAll(btnPanel1, btnPanel2, btnPanel3);
        //root.setTop(toolBar);
        VBox botonera = new VBox(10);
        botonera.getChildren().addAll(btnPanel1, btnPanel2, btnPanel3);
