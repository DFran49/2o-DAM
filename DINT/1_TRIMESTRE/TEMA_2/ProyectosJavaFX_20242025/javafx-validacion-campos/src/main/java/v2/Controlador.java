...
//        });
        ...
        //El segundo parámetro indica visualización de triángulo rojo
        vSmail.registerValidator(emailTextField, false, Validator.createRegexValidator("El formato del email es inválido", "^(.+)@(.+)\\.(.+)$", Severity.ERROR));
        ...
        vSedad.registerValidator(edadTextField, false, rangoValidator);
