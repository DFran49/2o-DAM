...
public class EjemploTableViewFoto extends Application {
    ...
    public void start(Stage primaryStage) throws InterruptedException, FileNotFoundException {
        ...
        //No se asocia ninguna columna para fotoURL (porque no nos interesa que salga la URL, pero sí la FOTO)
        //Pero si creamos una columna NO asociada a ninguna propiedad del objeto RobotFoto
        ...
        TableColumn<RobotFoto, Boolean> c4=new TableColumn<>("Está Vivo?");
        c4.setCellValueFactory(cellData ->
                new ReadOnlyBooleanWrapper(cellData.getValue().isSigueconvida()));
       //Probar el efecto de comentar la siguiente línea
         c4.setCellFactory(CheckBoxTableCell.<RobotFoto>forTableColumn(c4));//Crea un nuevo objeto
