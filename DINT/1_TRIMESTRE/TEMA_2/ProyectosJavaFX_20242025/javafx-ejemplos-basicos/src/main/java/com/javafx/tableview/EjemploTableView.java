...
public class EjemploTableView extends Application {
    ...
    public void start(Stage primaryStage) throws InterruptedException, FileNotFoundException {
        ...
        //Por tanto, lo primero es crear el modelo
        ...
        //setCellValueFactory indica como se RELACIONAN columnas y datos
        ...
        tableView.setOnMouseClicked(e -> {
             ...
             // getSelectionModel.isEmpty() : Se suele usar cuando desde otro lugar (otro botón) queremos
             // comprobar si se ha pinchado en algún elemento
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((observable, viejoValor, nuevoValor) -> {
            ...
            if (nuevoValor != null) {
                ...
                System.out.println("Elemento seleccionado: " + robotSelec.getNombre());
            }
        });
