...
public class componentesbasicos extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        comboBox = new ComboBox(); //Se podría haber rellenado con un OL // new ComboBox<>(...)
        ...
        //representa que estamos consultando una propiedad que puede cambiar,
        //No tiene por qué llamarse 'observable'
