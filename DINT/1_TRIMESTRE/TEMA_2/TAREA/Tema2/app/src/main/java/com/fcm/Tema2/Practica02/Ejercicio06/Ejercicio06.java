 ...
 */
public class Ejercicio06 extends Application {
    GridPane gridPane;
    ...
    private void añadir() {
        ...
        btnInsertar.setOnAction(event -> {
            listCerveza.add(new Cerveza(new Image(txtURL.getText()),txtNombre.getText(),txtNacionalidad.getText(),parseInt(txtGraduacion.getText())));
            rellenarGrid();
            crear.close();
        });
