...
class Pokemon
{
	...
	function insertar()
	{
		...
		$stmt->bind_param("ssssssssds", $this->Especie, $this->Denominacion, $this->Descripcion, $this->Sprite, $this->Tipo_1, $this->Tipo_2, 
	...
	function actualizar()
	{
		...
		$stmt->bind_param("ssssssssdsi", $this->Especie, $this->Denominacion, $this->Descripcion, $this->Sprite, $this->Tipo_1, $this->Tipo_2, 
