...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if(
		...
		mandarError(0,"Se han enviado correctamente los datos para matricular un alumno, pero el api aún no implementa esta funcionalidad. Considera el ejercicio correctamente superado");
